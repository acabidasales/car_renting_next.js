...
import { updateCoche } from "@/lib/actions";

const UpdateCar = ({ car, isOpen, closeModal }: UpdateCarProps) => {
  const [formData, setFormData] = useState({
        id: car.id,
        marca: car.marca,
        modelo: car.modelo,
        caballos: car.caballos,
        año: car.año,
        tipo_combustible: car.tipo_combustible,
        tipo_transmision: car.tipo_transmision,
        precio: car.precio,
        imagen_link: car.imagen_link,
  });
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        defaultValue={car.tipo_combustible}
                        onChange={handleChange}
                    ...
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        defaultValue={car.tipo_transmision}
                        onChange={handleChange}
